...
import { StyledNavbarLeftWrapper, StyledNavbarMainWrapper, StyledNavbarRightWrapper, StyledNavbarSearchBoxWrapper } from "./Navbar.style";
...
const Navbar = () => {
  ...
  const links=currentUser? <SignedIn displayName={currentUser?.displayName}/>:<SignedOut />
